...
require_once __DIR__ . '/validation/get_validation_message.php';
require_once __DIR__ . '/validation/validate_string.php';
require_once __DIR__ . '/util/mail/send_confirm_email.php';
require_once __DIR__ . '/util/mail/send_welcome_mail.php';
