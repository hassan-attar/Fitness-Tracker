...
require_once __DIR__.'/component/review_form.php';
                ...
                <form method="GET">
                    <div class="by-ing">
                        ...
                        <div class="ing-to-have">
                            ...
                            <input type="text" list="ingredientList" placeholder="Select and press Enter"
                                id="ing-to-have">
                        ...
                        <div class="by-cal">
                            ...
                            <span
                                class="from"><?= isset($_GET["minCal"]) && !empty($_GET["minCal"])? $_GET["minCal"]: '0' ?>
                                Cal</span><span
                                class="to"><?= isset($_GET["maxCal"]) && !empty($_GET["maxCal"])? $_GET["maxCal"]: '1000' ?>
                                Cal</span>
                        </div>
                    </div>
